...
public class AppPerformee {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("""
                    +-------------------------------+
                    |   Login \033[1;34mperformee.\033[m            |""");

            System.out.println("""
                    +-------------------------------+
                    | \033[1;35m1)\033[m Login Como Usuário         |
                    | \033[1;35m2)\033[m Login Como Admin           |
            ...
            switch (opcaoLogin) {
                ...
                default: {
                    System.out.println("Opção \033[1;31minválida!\033[m");
                }
            }

        } while (!dao.getLoginPermition().equals(true));


        if (dao.getLoginPermition().equals(true)) {

            do {
                System.out.print("""
                        +----------------------------------------------+
                        Digite o Ip do Servidor:""");
                ipServidor = leitorString.nextLine();
